    ...
    return (
        <div>
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className='flex w-full max-w-[520px] flex-col gap-6 border-one bg-dark-1 px-6 py-9 text-white'>
                    <div className='flex flex-col gap-6'>
                        ...
                        <h1 className={cn('text-3xl font-bold leaing-[42px]', className)}> {title}</h1>
                        {children}
